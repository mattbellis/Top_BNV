...
plot_defs['bnv_j1_mag_CMtop'] = {"xlabel":r"BNV $j_1$ $|p|$ CM$_{\rm top}$ (GeV/c)", "ylabel":r"# E","range":(0,200),'nbins':50}
plot_defs['bnv_j2_mag_CMtop'] = {"xlabel":r"BNV $j_2$ $|p|$ CM$_{\rm top}$ (GeV/c)", "ylabel":r"# E","range":(0,200),'nbins':50}
plot_defs['bnv_j3_mag_CMtop'] = {"xlabel":r"BNV $j_3$ $|p|$ CM$_{\rm top}$ (GeV/c)", "ylabel":r"# E","range":(0,200),'nbins':50}
...
plot_defs['had_j1_mag_CMtop'] = {"xlabel":r"hadronic $j_1$ $|p|$ CM$_{\rm top}$ (GeV/c)", "ylabel":r"# E","range":(0,200),'nbins':50}
plot_defs['had_j2_mag_CMtop'] = {"xlabel":r"hadronic $j_2$ $|p|$ CM$_{\rm top}$ (GeV/c)", "ylabel":r"# E","range":(0,200),'nbins':50}
plot_defs['had_j3_mag_CMtop'] = {"xlabel":r"hadronic $j_3$ $|p|$ CM$_{\rm top}$ (GeV/c)", "ylabel":r"# E","range":(0,200),'nbins':50}
